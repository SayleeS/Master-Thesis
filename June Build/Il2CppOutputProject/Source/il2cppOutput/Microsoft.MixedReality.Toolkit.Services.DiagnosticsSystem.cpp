...
IL_01db:
	{
		...
		*((float*)L_60) = (float)((float)il2cpp_codegen_subtract((float)L_61, (float)L_63));
		...
		Color_t119BCA590009762C7223FDD3AF9706653AC84ED2  L_67 = MixedRealityToolkitVisualProfiler_CalculateFrameColor_mE2F6BAE0F5EFCBB860F882B7B2D8AA51A8E230A8(__this, (il2cpp_codegen_cast_double_to_int<int32_t>(L_66)), /*hidden argument*/NULL);
