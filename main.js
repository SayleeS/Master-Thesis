...
function MAIN_Init3DButtons() {
    ...
    //creates the button
    var mopopCnrButton = RT.MRTK.SpawnButton("UIBTN-mopopcnr", "Patient Vitals", "Patient Vitals", false, function () { CNR_InitFromId(	"b4a1401b.0113a");  } );
    MAIN.buttons.push(mopopCnrButton);
    //change the button on unity
    RT.Unity.SetParent(mopopCnrButton.go, MAIN.palmHandMenuGo);
    RT.Unity.SetLocalPose(mopopCnrButton.go, null,[ 0.02, 0.1, 0],  null);
