...
{
	{
		...
		__this->set_minDistance_14((0.3f));
		// private float maxDistance = 0.6f;
		__this->set_maxDistance_15((0.6f));
		// private float maxViewDegrees = 15f;
		__this->set_maxViewDegrees_17((15.0f));
		// private float aspectV = 1f;
		__this->set_aspectV_18((1.0f));
		// private bool useFixedVerticalPosition = true;
		__this->set_useFixedVerticalPosition_21((bool)1);
		// private float fixedVerticalPosition = -0.15f;
		__this->set_fixedVerticalPosition_22((-0.15f));
		Solver__ctor_m7E20064756DEC591CBBA854D673CE17BA4D22351(__this, /*hidden argument*/NULL);
		return;
	}
}
