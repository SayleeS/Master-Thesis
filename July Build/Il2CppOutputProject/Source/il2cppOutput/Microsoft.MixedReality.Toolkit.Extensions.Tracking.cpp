...
IL_0023:
		{
			...
			LostTrackingServiceProfile_tCAB66FE182D3AB645A05494F27B751AAB8DF4B48 * L_7 = __this->get_profile_9();
			NullCheck(L_7);
			bool L_8 = LostTrackingServiceProfile_get_HaltTimeWhileTrackingLost_mF21B27914B50E855CA15C6555EB49DB90F5E4BB0_inline(L_7, /*hidden argument*/NULL);
			if (!L_8)
			{
				goto IL_004b;
			}
...
IL_004b:
		{
			...
			LostTrackingServiceProfile_tCAB66FE182D3AB645A05494F27B751AAB8DF4B48 * L_10 = __this->get_profile_9();
			NullCheck(L_10);
			bool L_11 = LostTrackingServiceProfile_get_HaltAudioOnTrackingLost_m7F4F453194B444F9BD1D7D36A22283C98E51E04C_inline(L_10, /*hidden argument*/NULL);
			if (!L_11)
			{
				goto IL_005e;
			}
...
IL_005e:
		{
			...
			NullCheck(L_12);
			InterfaceActionInvoker1< bool >::Invoke(1 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::set_Enabled(System.Boolean) */, ILostTrackingVisual_t97391BA7D459B5C7472552DA3CF514F8FA542D3F_il2cpp_TypeInfo_var, L_12, (bool)0);
		}
...
IL_0016:
		{
			...
			LostTrackingServiceProfile_tCAB66FE182D3AB645A05494F27B751AAB8DF4B48 * L_3 = __this->get_profile_9();
			NullCheck(L_3);
			GameObject_tBD1244AD56B4E59AAD76E5E7C9282EC5CE434F0F * L_4 = LostTrackingServiceProfile_get_TrackingLostVisualPrefab_mD08FCDCD72FB6C24085A4F6D28466B04EA103958_inline(L_3, /*hidden argument*/NULL);
			IL2CPP_RUNTIME_CLASS_INIT(Object_tAE11E5E46CD5C37C9F3E8950C00CD8B45666A2D0_il2cpp_TypeInfo_var);
...
IL_0030:
		{
			...
			NullCheck(L_8);
			RuntimeObject* L_9 = GameObject_GetComponentInChildren_TisILostTrackingVisual_t97391BA7D459B5C7472552DA3CF514F8FA542D3F_m0B726F8F700DBE795850CDBB1178B89275D581D7(L_8, /*hidden argument*/GameObject_GetComponentInChildren_TisILostTrackingVisual_t97391BA7D459B5C7472552DA3CF514F8FA542D3F_m0B726F8F700DBE795850CDBB1178B89275D581D7_RuntimeMethod_var);
...
IL_0053:
		{
			...
			NullCheck(L_11);
			InterfaceActionInvoker1< bool >::Invoke(1 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::set_Enabled(System.Boolean) */, ILostTrackingVisual_t97391BA7D459B5C7472552DA3CF514F8FA542D3F_il2cpp_TypeInfo_var, L_11, (bool)0);
		}
...
IL_005f:
		{
			...
			RuntimeObject* L_12 = __this->get_visual_10();
			NullCheck(L_12);
			bool L_13 = InterfaceFuncInvoker0< bool >::Invoke(0 /* System.Boolean Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::get_Enabled() */, ILostTrackingVisual_t97391BA7D459B5C7472552DA3CF514F8FA542D3F_il2cpp_TypeInfo_var, L_12);
			if (L_13)
			{
				goto IL_00fb;
			}
...
IL_006f:
		{
			...
			Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_17 = CameraCache_get_Main_mAAA0F0D4FB1C64120E7E88F796BA9E0E7547F2B6(/*hidden argument*/NULL);
			LostTrackingServiceProfile_tCAB66FE182D3AB645A05494F27B751AAB8DF4B48 * L_18 = __this->get_profile_9();
			NullCheck(L_18);
			LayerMask_tBB9173D8B6939D476E67E849280AC9F4EC4D93B0  L_19 = LostTrackingServiceProfile_get_TrackingLostCullingMask_m293A9060420C1F3447F5354357F2ED4CB3AF57A5_inline(L_18, /*hidden argument*/NULL);
			...
			// if (profile.HaltTimeWhileTrackingLost)
			LostTrackingServiceProfile_tCAB66FE182D3AB645A05494F27B751AAB8DF4B48 * L_21 = __this->get_profile_9();
			NullCheck(L_21);
			bool L_22 = LostTrackingServiceProfile_get_HaltTimeWhileTrackingLost_mF21B27914B50E855CA15C6555EB49DB90F5E4BB0_inline(L_21, /*hidden argument*/NULL);
			if (!L_22)
			{
				goto IL_00bb;
			}
...
IL_00bb:
		{
			// if (profile.HaltAudioOnTrackingLost)
			LostTrackingServiceProfile_tCAB66FE182D3AB645A05494F27B751AAB8DF4B48 * L_23 = __this->get_profile_9();
			NullCheck(L_23);
			bool L_24 = LostTrackingServiceProfile_get_HaltAudioOnTrackingLost_m7F4F453194B444F9BD1D7D36A22283C98E51E04C_inline(L_23, /*hidden argument*/NULL);
			if (!L_24)
			{
				goto IL_00ce;
			}
...
IL_00ce:
		{
			...
			NullCheck(L_25);
			InterfaceActionInvoker1< bool >::Invoke(1 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::set_Enabled(System.Boolean) */, ILostTrackingVisual_t97391BA7D459B5C7472552DA3CF514F8FA542D3F_il2cpp_TypeInfo_var, L_25, (bool)1);
			// visual.SetLayer(profile.TrackingLostVisualLayer);
			RuntimeObject* L_26 = __this->get_visual_10();
			LostTrackingServiceProfile_tCAB66FE182D3AB645A05494F27B751AAB8DF4B48 * L_27 = __this->get_profile_9();
			NullCheck(L_27);
			int32_t L_28 = LostTrackingServiceProfile_get_TrackingLostVisualLayer_m834925455F01EC20A23E258BF8B017A00555C8D9_inline(L_27, /*hidden argument*/NULL);
			NullCheck(L_26);
			InterfaceActionInvoker1< int32_t >::Invoke(2 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::SetLayer(System.Int32) */, ILostTrackingVisual_t97391BA7D459B5C7472552DA3CF514F8FA542D3F_il2cpp_TypeInfo_var, L_26, L_28);
			// visual.ResetVisual();
			RuntimeObject* L_29 = __this->get_visual_10();
			NullCheck(L_29);
			InterfaceActionInvoker0::Invoke(3 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::ResetVisual() */, ILostTrackingVisual_t97391BA7D459B5C7472552DA3CF514F8FA542D3F_il2cpp_TypeInfo_var, L_29);
		}
...
IL_0017:
		{
			...
			LostTrackingService_set_TrackingLost_m61D622A14DA7342E1285BD5D89D96CB8DDD69286_inline(__this, L_4, /*hidden argument*/NULL);
			// if (TrackingLost)
			bool L_5 = LostTrackingService_get_TrackingLost_m0BA15E281B59620A7214613376D47552FF10B991_inline(__this, /*hidden argument*/NULL);
			if (!L_5)
			{
				goto IL_003f;
			}
...
IL_0026:
		{
			...
			Action_t591D2A86165F896B4B800BB5C25CE18672A55579 * L_6 = LostTrackingService_get_OnTrackingLost_mA6B34796D1DB341DF9D680C15C4C1367881C7841_inline(__this, /*hidden argument*/NULL);
...
IL_003f:
		{
			...
			Action_t591D2A86165F896B4B800BB5C25CE18672A55579 * L_8 = LostTrackingService_get_OnTrackingRestored_m8541DC3FDB2CD907BE383C7EF85B03B30F0CCE2E_inline(__this, /*hidden argument*/NULL);
